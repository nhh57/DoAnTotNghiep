...
public class AccountServiceImpl implements AccountService {
    ...
    public List<Account> getAllAccount(int pageNumber,int pageSize, String keySearch, int isDeleted,int roleId) throws Exception {
        return accountRepo.getAllAccount(PageRequest.of(pageNumber - 1, pageSize),keySearch, isDeleted, roleId);
    }
